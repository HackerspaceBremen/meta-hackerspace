...
#Taken from meta-raspberry - gamecompiler 25.5.2018 18:00
...
do_deploy() {
    ...
    # Raspberry Pi touchscreen - gamecompiler
    if [ ! -z "${LCD_ROTATE}"]; then
        echo "# Enable lcd rotate" >>${DEPLOYDIR}/bcm2835-bootfiles/config.txt
        echo "display_rotate=${LCD_ROTATE}" >>${DEPLOYDIR}/bcm2835-bootfiles/config.txt
    fi
